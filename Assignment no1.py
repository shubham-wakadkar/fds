...
def Main() :
   ...
   while True :
       ...
       print ("\t5 : List of students who play  cricket,badminton and football")
       print ("\t6 : Exit")
       ...
       if (ch == 6):
           ...
           display_set(Group_C,"Football")
           find_union_set(Group_A,Group_B,R1)
           find_union_set(R1,Group_C,R2)
           display_set(R2,"No of students who play  cricket,badminton and football=")
